...
void CAN_driver_t::hardware_initialization(void) {
	__HAL_RCC_CAN1_CLK_ENABLE()	;
		...
		hcan.Init.Prescaler = 5000000 / 100000;
		...
		NVIC_SetPriority(CAN1_SCE_IRQn, CAN_INTERRUPT_PRIORITY);
		...
		CAN1->IER |= CAN_IT_EWG | CAN_IT_EPV | CAN_IT_BOF | CAN_IT_LEC | CAN_IT_ERR; // error interrupts
	#endif
}
